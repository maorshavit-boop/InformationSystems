...
('P-002', 'עידן', 'ק', 'קזנסקי', 'Haifa', 'B', '2', '2011-01-01', TRUE),
('P-003', 'אמיליה', 'א', 'ארהרט', 'Eilat', 'C', '3', '2012-01-01', TRUE),
('P-004', 'צחי', 'י', 'יגור', 'Jerusalem', 'D', '4', '2013-01-01', TRUE),
('P-005', 'שולי', 'ס', 'סולומון', 'Tel Aviv', 'E', '5', '2014-01-01', TRUE),
('P-006', 'חנן', 'ס', 'סלע', 'Rishon', 'F', '6', '2020-01-01', FALSE),
('P-007', 'וודג', 'א', 'אנטילס', 'Holon', 'G', '7', '2021-01-01', FALSE),
('P-008', 'סטאר', 'ת', 'תבור', 'Bat Yam', 'H', '8', '2022-01-01', FALSE),
('P-009', 'אלון', 'א', 'אדמה', 'Rehovot', 'I', '9', '2023-01-01', FALSE),
('P-010', 'פוקס', 'מ', 'מקלוד', 'Tel Aviv', 'J', '10', '2024-01-01', FALSE),
('P-011', 'יותם', 'ד', 'כהן', 'Tel Aviv', 'R', '11', '2015-01-01', TRUE),
('P-012', 'נועה', 'ס', 'לוי', 'Haifa', 'H', '12', '2016-05-15', TRUE),
('P-013', 'עידו', 'מ', 'מזרחי', 'Eilat', 'T', '13', '2018-02-20', FALSE),
('P-014', 'דנה', 'ר', 'פרץ', 'Jerusalem', 'J', '14', '2019-11-10', FALSE),
('P-015', 'גיא', 'ע', 'אזולאי', 'Rishon', 'J', '15', '2010-06-30', TRUE),
('P-016', 'רוני', 'מ', 'פרידמן', 'Tel Aviv', 'D', '16', '2021-01-01', FALSE),
('P-017', 'אייל', 'ה', 'גולן', 'Rehovot', 'H', '17', '2014-08-14', TRUE),
('P-018', 'תמר', 'י', 'כץ', 'Givatayim', 'K', '18', '2017-03-22', TRUE),
('P-019', 'עומר', 'א', 'ביטון', 'Tel Aviv', 'A', '19', '2020-09-09', FALSE),
('P-020', 'שירה', 'ל', 'שפירא', 'Haifa', 'M', '20', '2012-12-12', TRUE),
('P-021', 'דורון', 'א', 'ששון', 'Holon', 'K', '21', '2016-04-01', TRUE),
('P-022', 'מאיה', 'ת', 'דגן', 'Raanana', 'A', '22', '2019-07-20', FALSE);

INSERT INTO Flight_Attendants VALUES
('FA-001', 'רחל', 'ג', 'גרין', 'Tel Aviv', 'A', '1', '2018-01-01', TRUE),
('FA-002', 'מוניקה', 'ג', 'גלר', 'Tel Aviv', 'B', '2', '2018-02-01', TRUE),
('FA-003', 'פיבי', 'ב', 'בופיי', 'Tel Aviv', 'C', '3', '2018-03-01', TRUE),
('FA-004', 'ג׳ואי', 'ט', 'טריביאני', 'Tel Aviv', 'D', '4', '2018-04-01', TRUE),
('FA-005', 'צ׳נדלר', 'מ', 'בינג', 'Tel Aviv', 'E', '5', '2018-05-01', TRUE),
('FA-006', 'רוס', 'ג', 'גלר', 'Tel Aviv', 'F', '6', '2018-06-01', TRUE),
('FA-007', 'ג׳רי', 'ס', 'סיינפלד', 'Haifa', 'G', '7', '2019-01-01', FALSE),
('FA-008', 'איליין', 'ב', 'בנס', 'Haifa', 'H', '8', '2019-02-01', FALSE),
('FA-009', 'ג׳ורג׳', 'ק', 'קוסטנזה', 'Haifa', 'I', '9', '2019-03-01', FALSE),
('FA-010', 'קוזמו', 'ק', 'קריימר', 'Haifa', 'J', '10', '2019-04-01', FALSE),
('FA-011', 'טד', 'מ', 'מוסבי', 'Eilat', 'K', '11', '2020-01-01', FALSE),
('FA-012', 'רובין', 'ס', 'שרבטסקי', 'Eilat', 'L', '12', '2020-02-01', FALSE),
('FA-013', 'ברני', 'ס', 'סטינסון', 'Eilat', 'M', '13', '2020-03-01', FALSE),
('FA-014', 'לילי', 'א', 'אולדרין', 'Eilat', 'N', '14', '2020-04-01', FALSE),
('FA-015', 'מרשל', 'א', 'אריקסון', 'Eilat', 'O', '15', '2020-05-01', FALSE),
('FA-016', 'מייקל', 'ס', 'סקוט', 'Jerusalem', 'P', '16', '2021-01-01', FALSE),
('FA-017', 'דווייט', 'ס', 'שרוט', 'Jerusalem', 'Q', '17', '2021-02-01', FALSE),
('FA-018', 'ג׳ים', 'ה', 'הלפרט', 'Jerusalem', 'R', '18', '2021-03-01', FALSE),
('FA-019', 'פאם', 'ב', 'ביזלי', 'Jerusalem', 'S', '19', '2021-04-01', FALSE),
('FA-020', 'ריאן', 'ה', 'הווארד', 'Jerusalem', 'T', '20', '2021-05-01', FALSE),
('FA-021', 'מיכל', 'א', 'כהן', 'Tel Aviv', 'U', '21', '2020-01-01', TRUE),
('FA-022', 'דניאל', 'ב', 'לוי', 'Ramat Gan', 'V', '22', '2021-02-01', TRUE),
('FA-023', 'שרה', 'ג', 'אברהם', 'Holon', 'W', '23', '2019-03-01', FALSE),
('FA-024', 'דוד', 'ד', 'יוסף', 'Bat Yam', 'X', '24', '2022-04-01', FALSE),
('FA-025', 'רחל', 'ה', 'יעקב', 'Tel Aviv', 'Y', '25', '2018-05-01', TRUE),
('FA-026', 'משה', 'ו', 'יצחק', 'Haifa', 'Z', '26', '2023-01-01', FALSE),
('FA-027', 'לאה', 'ז', 'ראובן', 'Jerusalem', 'AA', '27', '2020-06-01', TRUE),
('FA-028', 'יוסי', 'ח', 'שמעון', 'Ashdod', 'BB', '28', '2021-07-01', FALSE),
('FA-029', 'רבקה', 'ט', 'לוי', 'Netanya', 'CC', '29', '2019-08-01', TRUE),
('FA-030', 'חיים', 'י', 'יהודה', 'Bnei Brak', 'DD', '30', '2022-09-01', FALSE),
('FA-031', 'אסתר', 'כ', 'דן', 'Petah Tikva', 'EE', '31', '2020-10-01', TRUE),
('FA-032', 'שלמה', 'ל', 'נפתלי', 'Tel Aviv', 'FF', '32', '2021-11-01', TRUE),
('FA-033', 'מרים', 'מ', 'גד', 'Ramat Gan', 'GG', '33', '2019-12-01', FALSE),
('FA-034', 'אברהם', 'נ', 'אשר', 'Givatayim', 'HH', '34', '2022-01-15', FALSE),
('FA-035', 'יעל', 'ס', 'יששכר', 'Herzliya', 'II', '35', '2018-02-20', TRUE),
('FA-036', 'יצחק', 'ע', 'זבולון', 'Raanana', 'JJ', '36', '2023-03-10', FALSE),
('FA-037', 'תמר', 'פ', 'בנימין', 'Kfar Saba', 'KK', '37', '2020-04-05', TRUE),
('FA-038', 'יעקב', 'צ', 'מנשה', 'Hod Hasharon', 'LL', '38', '2021-05-25', FALSE),
('FA-039', 'שרה', 'ק', 'אפרים', 'Rosh Haayin', 'MM', '39', '2019-06-30', TRUE),
('FA-040', 'אהרון', 'ר', 'חיים', 'Elad', 'NN', '40', '2022-07-12', FALSE),
('FA-041', 'דנה', 'ש', 'זילבר', 'Tel Aviv', 'OO', '41', '2021-01-01', TRUE),
('FA-042', 'בן', 'ת', 'שחר', 'Haifa', 'PP', '42', '2022-02-02', TRUE),
('FA-043', 'גל', 'א', 'מלכה', 'Eilat', 'QQ', '43', '2023-03-03', FALSE),
('FA-044', 'נועם', 'ב', 'בר', 'Jerusalem', 'RR', '44', '2020-04-04', FALSE),
('FA-045', 'שיר', 'ג', 'טל', 'Rishon', 'SS', '45', '2019-05-05', TRUE);
