...
-- 15. Unregistered Customers table
...
CREATE TABLE Flight_Tickets (
    ...
    airplane_id VARCHAR(20),
    price DECIMAL(10, 2),
    PRIMARY KEY (order_code, flight_id, row_num, class_type),
    FOREIGN KEY (order_code) REFERENCES Orders(order_code),
    FOREIGN KEY (flight_id) REFERENCES Flights(flight_id),
    FOREIGN KEY (row_num, column_num, class_type) REFERENCES Seats(row_num, column_num, class_type)
);